          ...
          <div class="ckeckBox">
            <template>
                ...
                <el-checkbox-group v-model="checkList">
                    <el-checkbox v-for="(item,index) in dataOrign" :label="item" :key="index"></el-checkbox>
                </el-checkbox-group>
            </template>
            <el-button size='small' class="checkListBtn1 checkListBtn">确定</el-button>
          ...
          <div class="ckeckBox">
            <template>
                ...
                <el-checkbox-group v-model="checkList2">
                    <el-checkbox v-for="(item,index) in need" :label="item" :key="index"></el-checkbox>
                </el-checkbox-group>
            </template>
            <el-button size='small' class="checkListBtn2 checkListBtn">确定</el-button>
          </div>
      </div>
